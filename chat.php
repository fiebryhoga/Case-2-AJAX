...
<body>
    ...
    <section class="container_chat">
        ...
        <div class="absolute container_card w-[370px] h-[550px] rounded-xl flex-col" id="cardChat"
            style="display: flex">
            <div
                class="pt-4 pb-2 px-6 header-card w-full flex items-center justify-between gap-6 rounded-t-xl bg-gradient-to-r from-[#2A37D7] via-[#1c73d6] via-[#1c73d6] via-[#1c73d6] to-[#21C6FB]">
                ...
                <div class="flex flex-col">
                    ...
                    <p class="w-full text-xs text-gray-100 opacity-60 tracking-wide">Pakai bahasa yang sopan ya gais ...
                    </p>
                </div>
                ...
                <form action="logout.php" method="post">
                    <button type="submit" id="logoutButton" class="cursor-pointer">
                        <div class="sign">
                            ...
                            <span
                                class="tooltip-logout opacity-0 absolute text-xs text-white -translate-y-9 -translate-x-7 w-12 font-medium">Log
                                Out</span>
                        </div>
                    </button>
                </form>
                ...
                <svg class="bg-white" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120"
                    ...
                    <defs>
                        <linearGradient id="grad" x1="0%" y1="0%" x2="100%" y2="0%">
                            ...
                            <!-- <stop offset="20%" stop-color="#1c73d6" /> -->
                            <stop offset="33%" stop-color="#1c73d6" />
                            <!-- <stop offset="38%" stop-color="#1c73d6" /> -->
